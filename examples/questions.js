...
import PassageThree from '../passages/passageThree';
...
const questionsArray = [
    ...
    new Question(
        ...
        <span>by pointing</span>,
        <span>pointing me</span>,
    ),
    new Question(
        13,
        ...
        <span>A.  NO CHANGE</span>,
        <span>It had taken me several weeks to find a summer job</span>,
        <span>Scuppernongs and muscadines are available at certain times of the year but not others</span>,
        <span>"Thank you," I said, noticing that it was a big bucket.</span>,
    ),
    new Question(
        14,
    ...
    new Question(
        ...
        ``,
        <span>A.  NO CHANGE</span>,
        <span>Under the circumstances,</span>,
        <span>Up close,</span>,
        <span>Or else,</span>,
    ),
    new Question(
        ...
        <span>Yes, I like heffalumps.</span>,
        <span>No, heffalumps are lame.</span>,
        <span>No, the essay is about woosels.</span>,
    ),
    new Question(
        17,
        ...
        <span>at point B</span>,
        <span>at point C</span>,
        <span>No division is possible.</span>,
    )
];
